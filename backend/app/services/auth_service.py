...
class AuthService:
    ...
    async def register(self, *, email: str, password: str, name: str | None, verification_code: str) -> tuple[str, uuid.UUID]:
        ...
        await self.email_verification.verify_register_code(email=email, code=verification_code)
